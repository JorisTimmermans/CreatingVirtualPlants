function [Trunk_o,Faces,Color,Polynomial] = Polygonal_Canopy_subbranch(Trunk,n,l,d,Tip,Curv)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
Angle_d         =           diff(cart2pol(Trunk(:,1),Trunk(:,2)));
Angle_r         =           Angle_d(2)/2;
[x,y,z]         =           Polygonal_Canopy_rotatecylindrical(Trunk(:,1),...       Rotating the vertices 
